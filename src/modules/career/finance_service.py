...
class FinanceService:
    ...
    async def process_monthly_tick_for_team(self, team: Team) -> Dict[str, Any]:
        ...
        if after_revenue >= payroll:
            ...
            after = Decimal("0")
            insolvent = True
            # Libera atletas mais baratos (menor salário) com CA baixo prioritário
            # até a folha restante caber na receita mensal
        ...
        logger.info(
            f"[Finance] {team.abbreviation}: {before:.0f} +{revenue:.0f} -{paid:.0f} "
